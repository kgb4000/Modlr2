  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved pin as @pin" do
        ...
        post :create, {:pin => { "name" => "invalid value" }}, valid_session
        assigns(:pin).should be_a_new(Pin)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested pin" do
        ...
        Pin.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => pin.to_param, :pin => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the pin as @pin" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Pin.any_instance.stub(:save).and_return(false)
        put :update, {:id => pin.to_param, :pin => { "name" => "invalid value" }}, valid_session
        assigns(:pin).should eq(pin)
      end
